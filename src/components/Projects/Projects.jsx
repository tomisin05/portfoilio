...
const Projects = () => {
  ...
  const projects = [
    ...
    {
        title: 'StockSmart AI',
        description: 'An i n t e lligent kitchen management system that combines inventory tracking with AI-powered recipe generation. Features smart recipe suggestions based on available ingredients, automated shopping list generation, and real-time inventory management. The application helps reduce food waste, optimize meal planning, and simplify the cooking process through intelligent automation and user-friendly interfaces.',
